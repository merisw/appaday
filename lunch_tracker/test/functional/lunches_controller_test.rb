...
class LunchesControllerTest < ActionController::TestCase
  ...
  test "should create lunch" do
    assert_difference('Lunch.count') do
      post :create, lunch: { calories: @lunch.calories, dairy: @lunch.dairy, drink: @lunch.drink, from: @lunch.from, meal: @lunch.meal }
    end
  ...
  test "should update lunch" do
    put :update, id: @lunch, lunch: { calories: @lunch.calories, dairy: @lunch.dairy, drink: @lunch.drink, from: @lunch.from, meal: @lunch.meal }
    assert_redirected_to lunch_path(assigns(:lunch))
  end
